...
private data class CaughtItem(private val arg: ItemEntitySpawnEvent.Arg) {
    val entity get() = arg.entity
    val pos get() = arg.pos
    val vel get() = arg.vel
    ...
    companion object {
        ...
        private fun Vec3d.nearBobber(bobberPos: Vec3d, bobberVel: Vec3d) =
            vecGetters.all { getter ->
                val b = bobberPos.getter()
                val abs = (getter() - b).absoluteValue
        ...
        private fun ItemEntitySpawnEvent.Arg.isCaughtFishVelocity(playerPos: Vec3d): Boolean {
        ...
        private fun ItemEntitySpawnEvent.Arg.isCaughtItem(bPos: Vec3d, bVel: Vec3d, pPos: Vec3d) =
            if (pos.nearBobber(bPos, bVel)) {
